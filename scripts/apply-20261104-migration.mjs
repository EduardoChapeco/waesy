...
const sqlPath = path.resolve(__dirname, "../supabase/migrations/20261104000000_airlines_cruises_cnae_health_insurance.sql");
...
async function run() {
  ...
  for (const cfg of configs) {
    ...
    try {
      ...
      console.log("Query OK! Aplicando migration 20261104000000 (Airlines, Cruises, CNAE, Health Insurance)...");
      await sql.unsafe(sqlContent);
      console.log("Migration 20261104000000 aplicada com sucesso!");
