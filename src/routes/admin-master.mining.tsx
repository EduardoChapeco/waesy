...
function AdminMiningHubPage() {
 ...
 <button className="inline-flex items-center gap-1.5 rounded-xl border border-border/70 bg-card px-3.5 py-2 text-xs font-semibold text-foreground hover:bg-muted/50 transition-all shadow-2xs">
