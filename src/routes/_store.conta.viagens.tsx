...
function CustomerTripsPage() {
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
    ...
    <div className="p-4 rounded-2xl bg-card border border-border/60 col-span-2 sm:col-span-1">
      ...
      <p className="text-xs text-muted-foreground mt-2 font-medium">
        Embarque oficial com validação por QR Code e suporte ao viajante.
      </p>
    </div>
  </div>
 ...
 {/* ── 2. Lista de Passeios do Marketplace ── */}
  ...
  <Badge
  variant="outline"
  className="text-[10px] font-bold border-border/80"
  >
 ...
 <div className="space-y-6">
  ...
  <Badge variant="outline" className="text-xs font-mono font-bold px-3 py-1 bg-muted">
  Voucher Digital
  </Badge>
