    ...
    <div className="w-full max-w-6xl mx-auto px-0 sm:px-4 md:px-6 py-0 sm:py-3 space-y-6 pb-28 lg:pb-12 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          {event.cover_image && (
            <div className="w-full aspect-video md:aspect-[16/9] overflow-hidden rounded-none sm:rounded-2xl border-y sm:border border-border/60 bg-muted relative">
              <img src={event.cover_image} alt={event.title} className="w-full h-full object-cover" />
              {event.is_external && (
                <div className="absolute top-3 left-3">
                  <Badge className="bg-background/90 text-foreground text-[11px] font-bold border border-border/50 uppercase tracking-wider">
            ...
            {linkedNews && (
              <div className="pt-4 border-t border-border/40 space-y-3">
                ...
                <Link
                  ...
                  className="block group p-4 rounded-none sm:rounded-2xl border-y sm:border border-border/80 bg-card hover:border-primary/50 transition-all"
                >
        ...
        <div className="lg:col-span-5 space-y-5 lg:sticky lg:top-24">
          ...
          <div className="p-5 sm:p-6 rounded-none sm:rounded-2xl border-y sm:border border-border/80 bg-card space-y-4">
          ...
          {/* ── Card 2: Ingressos ── */}
          <div className="p-5 sm:p-6 rounded-none sm:rounded-2xl border-y sm:border border-border/80 bg-card space-y-5">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-card/95 backdrop-blur-md border-t border-border/60 px-4 py-3 flex items-center justify-between gap-3 select-none pb-safe">
        <div>
        ...
        {(event.is_external || event.is_external_ticket) && event.external_ticket_url ? (
          <Button asChild size="lg" className="h-11 px-5 rounded-xl font-bold text-xs bg-foreground text-background gap-1.5 cursor-pointer">
          ...
          <Button
            size="lg"
            className="h-11 px-6 rounded-xl font-bold text-xs bg-primary text-primary-foreground gap-1.5 cursor-pointer"
